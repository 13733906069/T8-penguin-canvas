...
function App() {
  ...
  useEffect(() => {
    const hasOpenTopSurface = cloudOpen || videoOpen || canvasTutorialOpen || zhenOpen || appOpen || aixOpen || resourceOpen || guomanOpen;
  ...
  }, [cloudOpen, videoOpen, canvasTutorialOpen, zhenOpen, appOpen, aixOpen, resourceOpen, guomanOpen]);
